class BookData < ActiveRecord::Base
  ...
  validates_attachment_content_type :logo, :content_type => /^image\/(jpg|jpeg|pjpeg|png|x-png|gif|svg+xml|tiff)$/, :message => 'O arquivo anexado não é compatível. Tente novamente ou entre em contato com nossos editores.'
