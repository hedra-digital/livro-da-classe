Livrodaclasse::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "demo.livrodaclasse.com.br", :sender_address => "nao-responda@livrodaclasse.com.br", :email_prefix => "[SALES - LIVRO DA CLASSE] ERRO NO SISTEMA " }
  ...
  email_prefix: "[DEMO - LIVRO DA CLASSE] ERRO NO SISTEMA - ",
